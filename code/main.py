...
def train_test_section_a():
    ...
    L = LLM(4, 4, 4999, data_path,save_files_prefix="mod1", optim_lambda_val=0.3)
    L.train(train_file)
...
def train_test_section_b():
    ...
    train_file = join(data_path, train_file_name)
    L = LLM(4, 4, 249, data_path ,save_files_prefix="mod2" ,optim_lambda_val=0.3)
    L.train(train_file)
    tags_file = L.tag_file_multi_2('test1.words')
...
if __name__ == '__main__':
    ...
    test(data_path, r"C:\git-projects\NLP\data\module1_fixed_tags_5_lambda_0.25_0_vit_m_5.wtag")
